package com.wishes.assistant.net.download;
...
public class NewPackageDownloadService extends Service {
    ...
    private void initDownManager() {
        ...
        down.setDestinationInExternalPublicDir(Environment.DIRECTORY_DOWNLOADS, "江大教务小助手.apk");
        down.setTitle("demo");
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        url = intent.getStringExtra(Constants.updateAPKUrl);
        String path = Environment.getExternalStorageDirectory().getAbsolutePath() + Environment.DIRECTORY_DOWNLOADS + "江大教务小助手.apk";
        ...
        try {
            ...
            e.printStackTrace();
            try {
                Uri uri = Uri.parse(Constants.updateAPKUrl);
    ...
    class DownloadCompleteReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (intent.getAction().equals(DownloadManager.ACTION_DOWNLOAD_COMPLETE)) {
                ...
                NewPackageDownloadService.this.stopSelf();
            }
        }

...
public class TestSelectorDialog extends AAH_FabulousFragment {
    ...
    public static TestSelectorDialog newInstance() {
        TestSelectorDialog dialog = new TestSelectorDialog();
        return dialog;
    }
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        params = ((Test) getActivity()).getParams();
    ...
    public void setupDialog(final Dialog dialog, int style) {
        ...
        rl_content.setBackgroundColor(getResources().getColor(R.color.btn_test));
        ...
        imgbtn_apply.setBackgroundColor(getResources().getColor(R.color.btn_test));
        imgbtn_refresh.setBackgroundColor(getResources().getColor(R.color.btn_test));
